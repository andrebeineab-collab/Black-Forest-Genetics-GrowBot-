...
@app_commands.choices(
    ...
    anbaumethode=[
        ...
        app_commands.Choice(name="Topping", value="Topping"),
        app_commands.Choice(name="SCROG", value="SCROG"),
        app_commands.Choice(name="Fimming", value="Fimming"),
        app_commands.Choice(name="SOG", value="SOG"),
...
async def eintrag(
    ...
    if pflanze:
        ...
        keimdatum = pflanze[1] if keimdatum in ("_", "—", "", None) else keimdatum
...
@app_commands.choices(
    ...
    topfgroesse=[
        app_commands.Choice(name="🪣 0,5 L / 0.13 US gal", value="0.5 L"),
        app_commands.Choice(name="🪣 1 L / 0.26 US gal", value="1 L"),
        app_commands.Choice(name="🪣 3 L / 0.79 US gal", value="3 L"),
        app_commands.Choice(name="🪣 5 L / 1.32 US gal", value="5 L"),
        app_commands.Choice(name="🪣 7 L / 1.85 US gal", value="7 L"),
        app_commands.Choice(name="🪣 9 L / 2.38 US gal", value="9 L"),
        app_commands.Choice(name="🪣 11 L / 2.91 US gal", value="11 L"),
        app_commands.Choice(name="🪣 15 L / 3.96 US gal", value="15 L"),
        app_commands.Choice(name="🪣 20 L / 5.28 US gal", value="20 L"),
        app_commands.Choice(name="🪣 25 L / 6.60 US gal", value="25 L"),
        app_commands.Choice(name="🪣 30 L / 7.93 US gal", value="30 L"),
    ],
    lampe=[
...
@bot.tree.command(
    name="breeder-anzeigen",
    description="Zeigt ein gespeichertes Breeder-Projekt an."
)
@app_commands.describe(
    projekt_id="Projekt-ID des Breeder-Projekts"
)
async def breeder_anzeigen(
    interaction: discord.Interaction,
    projekt_id: int
):
    projekt = lade_breeder_projekt(
    ...
    embed = discord.Embed(
        title=f"🧬 Breeder-Projekt – {projektname}",
        description=f"Projekt-ID: **{projekt_id_db}**"
    )

    embed.add_field(
        name="🌱 Mutterpflanze",
        value=mutterpflanze or "-",
        inline=True
    )

    embed.add_field(
        name="🌿 Vaterpflanze",
        value=vaterpflanze or "-",
        inline=True
    )
    ...
    embed.add_field(
        name="🌰 Samenanzahl",
        value=str(samenanzahl) if samenanzahl is not None else "-",
        inline=True
    )
